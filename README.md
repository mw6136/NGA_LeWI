...
In order for [NGA](#nga) to incorporate our grid specifications into `init_flow`, we will append `example_simulation.f90` to the end of the `F90FILES` field in the `Makefile` of `~/NGA/src/tools/init_flow`. The `Makefile` should look like:
