...
!----------------------------------------------------------
      implicit none
      double precision :: C(0), TEMP, PRESSURE, CDOT_m(0)

end subroutine consrates
...
!     THE PARAMETERS H AND CP SHOULD PROVIDE WORKSPACE OF LENGTH ?.
!------------------------------------------------------------------
      implicit none
      double precision :: JAC(0,0), Y(0), T, P

end subroutine compchemjacobian
