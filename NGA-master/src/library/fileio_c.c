...
void BINARY_FILE_WRITE_LONG(int* unit, const void* buffer, long* count, int* size, int* ierr);
void BINARY_FILE_READ(int* unit, void* buffer, int* count, int* size, int* ierr);
void BINARY_FILE_READ_LONG(int* unit, void* buffer, long* count, int* size, int* ierr);
...
void binary_file_write_long(int* unit, const void* buffer, long* count, int* size, int* ierr){
  BINARY_FILE_WRITE_LONG(unit, buffer, count, size, ierr);
}
void binary_file_write_long_(int* unit, const void* buffer, long* count, int* size, int* ierr){
  BINARY_FILE_WRITE_LONG(unit, buffer, count, size, ierr);
}
void binary_file_write_long__(int* unit, const void* buffer, long* count, int* size, int* ierr){
  BINARY_FILE_WRITE_LONG(unit, buffer, count, size, ierr);
}
void binary_file_read(int* unit, void* buffer, int* count, int* size, int* ierr){
...
void binary_file_read_long(int* unit, void* buffer, long* count, int* size, int* ierr){
  BINARY_FILE_READ_LONG(unit, buffer, count, size, ierr);
}
void binary_file_read_long_(int* unit, void* buffer, long* count, int* size, int* ierr){
  BINARY_FILE_READ_LONG(unit, buffer, count, size, ierr);
}
void binary_file_read_long__(int* unit, void* buffer, long* count, int* size, int* ierr){
  BINARY_FILE_READ_LONG(unit, buffer, count, size, ierr);
}
void create_folder(const char* file, const int size){
...
void BINARY_FILE_OPEN(int* unit, const char* file, const char* mode, int* ierr, const int size1, const int size2){
  ...
  char filename[128/*size_file*/];
  strncpy(filename,file,(size_t) size1);
  filename[size1] = '\0';

  char format[128/*size_file*/];
...
/* Write to a file -- when LONG INT is necessary for filesize (1280^3 and greater)*/
void BINARY_FILE_WRITE_LONG(int* unit, const void* buffer, long* count, int* size,  int* ierr){
