...
subroutine sydneyinflowfine_grid
  ...
  if (ny-1.gt.(2*ny_int)) then
     ! Fuel Jet
     do j=1,ny_int+1
        y(j) = jet_diameter/2.0_WP*tanh(1.684_WP*real(j-1,WP)/ny_int)/tanh(1.684_WP)
     end do
     ! Wall
     ...
     do j=ny-ny_int, ny
        ...
        y(j) = 0.5_WP*height*tanh(1.674_WP*(2.0_WP*real(j-(ny-ny_int),WP)/ny_int-1.0_WP))/tanh(1.674_WP) & 
