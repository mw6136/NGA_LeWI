module prem_flamelet
 ...
 ! real(WP) :: TOT_ENTHALPY
  ...
  ! Particular variables for PFPVA
  real(WP) :: PHI
  real(WP) :: Z
  real(WP) :: Zst
  
end module prem_flamelet
...
subroutine prem_flamelet_init
  ...
  return
end subroutine prem_flamelet_init
...
! ================================================ !
subroutine prem_flamelet_readfile(filename)
  use prem_flamelet
  use fileio
  use parser
  implicit none
  ...
  return
end subroutine prem_flamelet_readfile


! ========================================= !
! Deallocate the data array for new reading !
! ========================================= !
subroutine prem_flamelet_cleanup
  use prem_flamelet
  implicit none
  ...
  return
end subroutine prem_flamelet_cleanup
