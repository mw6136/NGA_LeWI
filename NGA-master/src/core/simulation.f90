...
!!$     call soot_step
     ...
     ! Recalculate chemtable lookup variables if using chemtable combustion
     call combustion_poststep
     
     ! Compute subfilter model variables for statistics
     call sgsmodel_poststep
